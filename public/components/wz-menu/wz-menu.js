...
import { getAngularModule, getHttp, getToasts, getUiSettings } from '../../kibana-services';
...
export const WzMenu = withWindowSize(class WzMenu extends Component {
  ...
  render() {
    ...
    const logotype_url = getHttp().basePath.prepend(`/plugins/wazuh/assets/${this.wazuhConfig.getConfig()[ darkMode ? 'customization.logo.maxWhite' : 'customization.logo.app']}`);
    const mainButton = (
